class Gt < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/pavlovic265/265-gt/releases/download/v0.50.6/gt_Darwin_arm64.tar.gz"
      sha256 "sha256:d4927bf9e2e4291e139495cbee0cb214e04c7fc9960a86a0f02140d2873001d7"
    end
    on_intel do
      url "https://github.com/pavlovic265/265-gt/releases/download/v0.50.6/gt_Darwin_x86_64.tar.gz"
